/* File: /home/seanf/workspace/pipeline/Release/_sds/p0/.cf_work/portinfo.c */
#include "cf_lib.h"
...
int _p0_swinst_Pipe_1_cmd_Pipe_sg_list[] = {0x8};

axi_lite_info_t _p0_swinst_Pipe_1_cmd_Pipe_info = {
  .phys_base_addr = 0x83c00000,
  .data_reg_offset = _p0_swinst_Pipe_1_cmd_Pipe_sg_list,
  .data_reg_sg_size = 1,
  ...
  .acc_info = &_sds__p0_Pipe_1,
};

axi_dma_sg_transaction_info_t _p0_swinst_Pipe_1_x_V_info = {
  .dma_info = &_p0_dm_0,
  .dma_channel = 0,
  .port_id = 0,
};

int _p0_swinst_Pipe_1_datalen_sg_list[] = {0xc};

axi_lite_info_t _p0_swinst_Pipe_1_datalen_info = {
  .phys_base_addr = 0x83c00000,
  .data_reg_offset = _p0_swinst_Pipe_1_datalen_sg_list,
  .data_reg_sg_size = 1,
...
struct _p0_swblk_Pipe _p0_swinst_Pipe_1 = {
  .cmd_Pipe = { .base = { .channel_info = &_p0_swinst_Pipe_1_cmd_Pipe_info}, 
    .send_i = &axi_lite_send },
  .x_V = { .base = { .channel_info = &_p0_swinst_Pipe_1_x_V_info}, 
    .send_i = &axi_dma_sg_send_i },
  .a_V_PORTA = { .base = { .channel_info = &_p0_dm_1},
    .send_i = &axi_dma_simple_send_i },
  .b_V_PORTA = { .base = { .channel_info = &_p0_dm_2},
    .send_i = &axi_dma_simple_send_i },
  .output_V = { .base = { .channel_info = &_p0_dm_3},
    .receive_ref_i = 0,
    .receive_i = &axi_dma_simple_recv_i },
  .datalen = { .base = { .channel_info = &_p0_swinst_Pipe_1_datalen_info}, 
    .send_i = &axi_lite_send },
};
...
void _p0_cf_framework_open(int first)
{
  ...
  axi_lite_open(&_p0_swinst_Pipe_1_cmd_Pipe_info);
  axi_lite_open(&_p0_swinst_Pipe_1_datalen_info);
  _sds__p0_Pipe_1.arg_dm_id[0] = _p0_swinst_Pipe_1_cmd_Pipe_info.dm_id;
  _sds__p0_Pipe_1.arg_dm_id[1] = _p0_swinst_Pipe_1_x_V_info.dma_info->chan_data[_p0_swinst_Pipe_1_x_V_info.dma_channel].dm_id;
  _sds__p0_Pipe_1.arg_dm_id[2] = _p0_dm_1.dm_id;
  _sds__p0_Pipe_1.arg_dm_id[3] = _p0_dm_2.dm_id;
  _sds__p0_Pipe_1.arg_dm_id[4] = _p0_dm_3.dm_id;
  _sds__p0_Pipe_1.arg_dm_id[5] = _p0_swinst_Pipe_1_datalen_info.dm_id;
  _sds__p0_Pipe_1.arg_dm_id_count = 6;
  accel_open(&_sds__p0_Pipe_1);
}

void _p0_cf_framework_close(int last)
{
  accel_close(&_sds__p0_Pipe_1);
  axi_dma_sg_close(&_p0_dm_0);
  axi_dma_simple_close(&_p0_dm_1);
  axi_dma_simple_close(&_p0_dm_2);
  axi_dma_simple_close(&_p0_dm_3);
  axi_lite_close(&_p0_swinst_Pipe_1_cmd_Pipe_info);
  axi_lite_close(&_p0_swinst_Pipe_1_datalen_info);
