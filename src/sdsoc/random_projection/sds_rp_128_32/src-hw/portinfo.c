/* File: /home/seanf/workspace/random-projection/Release/_sds/p0/.cf_work/portinfo.c */
#include "cf_lib.h"
...
struct _p0_swblk_RandomProjection _p0_swinst_RandomProjection_1 = {
  ...
  .output_V = { .base = { .channel_info = &_p0_dm_1},
    .receive_ref_i = 0,
...
void _p0_cf_framework_open(int first)
{
  ...
  _sds__p0_RandomProjection_1.arg_dm_id[1] = _p0_dm_0.dm_id;
  _sds__p0_RandomProjection_1.arg_dm_id[2] = _p0_dm_1.dm_id;
