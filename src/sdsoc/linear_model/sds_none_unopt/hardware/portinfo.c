/* File: /home/seanf/workspace/linearFloat/Release/_sds/p0/.cf_work/portinfo.c */
#include "cf_lib.h"
...
int _p0_swinst_LinReg_1_cmd_LinReg_sg_list[] = {0x80c, 0x8};
...
axi_dma_sg_transaction_info_t _p0_swinst_LinReg_1_x_PORTA_info = {
  .dma_info = &_p0_dm_0,
  .dma_channel = 0,
  .port_id = 0,
};

int _p0_swinst_LinReg_1_b_sg_list[] = {0xc};

axi_lite_info_t _p0_swinst_LinReg_1_b_info = {
  .phys_base_addr = 0x83c00000,
  .data_reg_offset = _p0_swinst_LinReg_1_b_sg_list,
  .data_reg_sg_size = 1,
...
axi_dma_sg_transaction_info_t _p0_swinst_LinReg_1_output_r_PORTA_info = {
  .dma_info = &_p0_dm_0,
  .dma_channel = 1,
  .port_id = 0,
};

int _p0_swinst_LinReg_1_datalen_sg_list[] = {0x10};
...
struct _p0_swblk_LinReg _p0_swinst_LinReg_1 = {
  ...
  .x_PORTA = { .base = { .channel_info = &_p0_swinst_LinReg_1_x_PORTA_info}, 
    .send_i = &axi_dma_sg_send_i },
  .a_PORTA = { .base = { .channel_info = &_p0_dm_1},
    .send_i = &axi_fifo_send },
  .b = { .base = { .channel_info = &_p0_swinst_LinReg_1_b_info}, 
    .send_i = &axi_lite_send },
  .output_r_PORTA = { .base = { .channel_info = &_p0_swinst_LinReg_1_output_r_PORTA_info}, 
    .receive_ref_i = 0,
...
void _p0_cf_framework_open(int first)
{
  ...
  axi_fifo_open(&_p0_dm_1);
  axi_lite_open(&_p0_swinst_LinReg_1_cmd_LinReg_info);
  axi_lite_open(&_p0_swinst_LinReg_1_b_info);
  axi_lite_open(&_p0_swinst_LinReg_1_datalen_info);
  _sds__p0_LinReg_1.arg_dm_id[0] = _p0_swinst_LinReg_1_cmd_LinReg_info.dm_id;
  _sds__p0_LinReg_1.arg_dm_id[1] = _p0_swinst_LinReg_1_x_PORTA_info.dma_info->chan_data[_p0_swinst_LinReg_1_x_PORTA_info.dma_channel].dm_id;
  _sds__p0_LinReg_1.arg_dm_id[2] = _p0_dm_1.dm_id;
  _sds__p0_LinReg_1.arg_dm_id[3] = _p0_swinst_LinReg_1_b_info.dm_id;
  _sds__p0_LinReg_1.arg_dm_id[4] = _p0_swinst_LinReg_1_output_r_PORTA_info.dma_info->chan_data[_p0_swinst_LinReg_1_output_r_PORTA_info.dma_channel].dm_id;
...
void _p0_cf_framework_close(int last)
{
  ...
  axi_fifo_close(&_p0_dm_1);
  axi_lite_close(&_p0_swinst_LinReg_1_cmd_LinReg_info);
  axi_lite_close(&_p0_swinst_LinReg_1_b_info);
