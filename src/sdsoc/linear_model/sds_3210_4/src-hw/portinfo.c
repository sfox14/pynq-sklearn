/* File: /home/seanf/workspace/lreg/Release/_sds/p0/.cf_work/portinfo.c */
#include "cf_lib.h"
...
void _p0_cf_framework_open(int first)
{
  ...
  _sds__p0_LinReg_1.arg_dm_id[3] = _p0_dm_2.dm_id;
  _sds__p0_LinReg_1.arg_dm_id[4] = _p0_dm_3.dm_id;
