...
#include "cf_stub.h"
extern "C" void _p0_Linneg_1_noasync(data_t x[13000], coef_t a[13], coef_t b, data_t output[1000], len_t datalen);
extern "C" void _p0_LinReg_1_noasync(data_t x[13000], coef_t a[13], coef_t b, data_t output[1000], len_t datalen)
{
  ...
  cf_send_i(&(_p0_swinst_LinReg_1.x), x, 52000, &_p0_request_0);
  cf_send_i(&(_p0_swinst_LinReg_1.a), a, 52, &_p0_request_1);
  cf_send_i(&(_p0_swinst_LinReg_1.b), &b, 4, &_p0_request_2);
  cf_send_i(&(_p0_swinst_LinReg_1.datalen), &datalen, 4, &_p0_request_4);

  cf_receive_i(&(_p0_swinst_LinReg_1.output_r), output, 4000, &_p0_LinReg_1_noasync_num_output_r, &_p0_request_3);
