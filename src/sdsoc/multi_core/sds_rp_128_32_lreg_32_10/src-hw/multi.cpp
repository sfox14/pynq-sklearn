...
extern "C" void _p0_RandomProjection_1_noasync(data_t * x, data_t * output, len_t datalen)
{
  ...
  cf_receive_i(&(_p0_swinst_RandomProjection_1.output_V), output, ((datalen*32)) * 4, &_p0_RandomProjection_1_async_1_num_output_V, &_p0_request_6);

  cf_wait(_p0_request_5);
  cf_wait(_p0_request_6);
  cf_wait(_p0_request_7);
  //cf_request_handle_t req_array[3] = {_p0_request_5, _p0_request_6, _p0_request_7};
...
extern "C" void _p0_LinReg_1_noasync(data_t * x, coef_t a[320], coef_t b[10], data_t * output, len_t datalen)
{
  ...
  cf_receive_i(&(_p0_swinst_LinReg_1.output_V), output, ((datalen*10)) * 4, &_p0_LinReg_1_async_2_num_output_V, &_p0_request_3);
  ...
  //cf_request_handle_t req_array[5] = {_p0_request_0, _p0_request_1, _p0_request_2, _p0_request_3, _p0_request_4};
  //sds_insert_req( 2, req_array, 5);
}
