...
void _p0_RandomProjection_1_noasync(data_t * x, data_t * output, len_t datalen);
...
//#pragma SDS async(1)
	_p0_RandomProjection_1_noasync(x, output, datalen);

	// Linear Regression
//#pragma SDS async(2)
	_p0_LinReg_1_noasync(x_lr, a_lr, b_lr, output_lr, datalen);
